...
export default function Home() {
  const reactUrl = process.env.NEXT_PUBLIC_REACT_URL;
  const nextUrl = process.env.NEXT_PUBLIC_NEXT_URL;
  const twitterUrl = process.env.NEXT_PUBLIC_TWITTER_URL;
  const githubUrl = process.env.NEXT_PUBLIC_GITHUB_URL;

  console.log("NEXT_PUBLIC_REACT_URL:", reactUrl);
  console.log("NEXT_PUBLIC_NEXT_URL:", nextUrl);
  console.log("NEXT_PUBLIC_TWITTER_URL:", twitterUrl);
  console.log("NEXT_PUBLIC_GITHUB_URL:", githubUrl);
    ...
    <div className="max-w-3xl mx-auto px-6 py-14">
      <header className="relative">
        ...
        <div className="absolute top-0 right-0 flex items-center space-x-4 mt-1">
          <a href={twitterUrl} className="text-black text-sm no-underline">
            <svg
          ...
          <a href={githubUrl} className="text-black text-sm no-underline">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
        ...
        <nav>
          ...
          <ul>
            <li className="mb-4">
              <a
                href={reactUrl}
                className="text-black text-sm underline underline-offset-4 cursor-pointer"
              >
                roadmap-react
              </a>
